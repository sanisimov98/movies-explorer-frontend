        ...
        <div className={"about-me__info"}>
          <div className={"about-me__texts"}>
            ...
            <p className={"about-me__text"}>
              Заканчиваю курс веб-разработки «Яндекс.Практикум», на котором
              научился верстать (HTML, CSS), программировать на нативном
              JavaScript, работать с фреймворком React. Также получил базовые
              представления о работе с Node.js.
            </p>
          </div>
