        ...
        <>
            ...
            >
                <div className="auth__container">
                    ...
                    <Switch>
                        <Route path={ ROUTES_MAP.SIGN_UP }>
                            <p className="auth__form-text">Уже зарегистрированы? <Link to={ROUTES_MAP.SIGN_IN} className="auth__form-link">Войти</Link></p>
                        </Route>
                        <Route path={ ROUTES_MAP.SIGN_IN }>
                            <p className="auth__form-text">Ещё не зарегистрированы? <Link to={ROUTES_MAP.SIGN_UP} className="auth__form-link">Регистрация</Link></p>
                        </Route>
                    </Switch>
                </div>
            </form>
