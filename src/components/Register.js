...
export default function Register({onRegister, isLoggedIn}) {
    ...
    return (
        <AuthForm name={"register"} onSubmit={handleSubmit}>
            ...
            />
            {nameValid ? <></> : <p className={"auth__error"}>Что-то пошло не так...</p>}
            ...
            />
            {emailValid ? <></> : <p className={"auth__error"}>Что-то пошло не так...</p>}
            ...
            />
            {passwordValid ? <></> : <p className={"auth__error"}>Что-то пошло не так...</p>}
        </AuthForm>
    )
}