        ...
        <div className="page">
          <Switch>
            ...
            <Route path={ROUTES_MAP.FILMS} >
              <Header isLoggedIn={isLoggedIn} />
              <Movies films={films} handleFilmSave={handleFilmSave} handleFilmRemove={handleFilmRemove} />
              <Footer />
            </Route>
            <Route path={ROUTES_MAP.SAVED_FILMS}>
              <Header isLoggedIn={isLoggedIn} />
              <SavedMovies films={savedFilms} handleFilmSave={handleFilmSave} handleFilmRemove={handleFilmRemove} />
              <Footer />
            </Route>
