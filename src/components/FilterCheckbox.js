    ...
    return (
        <div className={"filter"}>
            <label className={"filter__label"}>
                <div
                    className={`filter__toggle ${shortFilmsSelected ? "filter__toggle_clicked" : ""}`}
                    onClick={handleCheckboxSelected}
                >
                    <div className={`filter__toggle-circle ${shortFilmsSelected ? "filter__toggle-circle_clicked" : ""}`}/>
                </div>
